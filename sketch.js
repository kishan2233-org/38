...
function preload(){
  ...
  backgroundImg = loadImage("tree bg.jpg")
...
function setup() {
 ...
 console.log(message)
  ...
  trex = createSprite(200,300,20,50);
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.5;
  
  //create a ground sprite
  ground = createSprite(5,305,5,20);
...
function spawnClouds() {
  ...
  function spawnHen() {
    //write code here to spawn the hen
    if (frameCount % 60 === 0) {
      var hen = createSprite(600,120,40,10);
      hen.x = Math.round(random(80,120));
